...
public class CarControllerTest {
    ...
    /**
     * Tests for successful updates of new car in the system
     * @throws Exception when car creation fails in the system
     */
    @Test
    public void putCar() throws Exception {
        ...
        mvc.perform(
                put(new URI(String.format("/cars/%s", 1)))
                        .content(json.write(car).getJson())
                        .contentType(MediaType.APPLICATION_JSON_UTF8)
                        .accept(MediaType.APPLICATION_JSON_UTF8))
    ...
    public void deleteCar() throws Exception {
        ...
        given(carService.findById(any())).willThrow(new CarNotFoundException("Cat not found!"));
